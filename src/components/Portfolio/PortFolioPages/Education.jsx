...
import img1 from '../../../media/New folder/edu/edu (1).jpg';
import img2 from '../../../media/New folder/edu/edu (2).jpg';
import img3 from '../../../media/New folder/edu/edu (3).jpg';
import img4 from '../../../media/New folder/edu/edu (4).jpg';
import img5 from '../../../media/New folder/edu/edu (5).jpg';
import img6 from '../../../media/New folder/edu/edu (6).jpg';
import img7 from '../../../media/New folder/edu/edu (7).jpg';
import img8 from '../../../media/New folder/edu/edu (8).jpg';
import img9 from '../../../media/New folder/edu/edu (9).jpg';
import img10 from '../../../media/New folder/edu/edu (10).jpg';
import img11 from '../../../media/New folder/edu/edu (11).jpg';
import img12 from '../../../media/New folder/edu/edu (12).jpg';
...
const Education = () => {
	...
	const digital = [img2, img3, img4, img5, img6, img7, img14];
		...
		<div>
			<div className='portfolio-top-container'>
				<img
					...
					alt='page top'
				/>
				<h2 className='portfolio-text display-1'>EDUCATION</h2>
			</div>
